...
public class SnowmanPanel extends JPanel{
  ...
  public void paintComponent (Graphics page)
  {
    ...
    page.drawArc (MID - 10, TOP + 20, 20, 10, 0, 160);   // smile
    ...
    page.fillOval (MID - 3, TOP + 45, 6, 6); // top button
    page.fillOval (MID - 3, TOP + 60, 6, 6);  // bottom button 
    
    page.drawString ("Reuben", 10, 15); // name
